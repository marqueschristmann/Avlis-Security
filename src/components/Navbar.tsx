    ...
    return (
        <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-background-dark/80 backdrop-blur-md border-b border-white/5 h-16' : 'h-20'}`}>
            <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
                ...
                <button className="border border-primary/30 hover:border-primary text-primary px-5 py-2 rounded-full font-bold text-[10px] transition-all tracking-widest uppercase">
                    Solicitar Proposta
                </button>
            </div>
        </nav>
